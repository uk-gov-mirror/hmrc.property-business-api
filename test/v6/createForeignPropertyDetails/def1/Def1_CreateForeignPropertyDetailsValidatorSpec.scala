  ...
  "validator" should {
    ...
    "return a single error" when {
      ...
      "passed an empty body" in {
        ...
        result shouldBe Left(ErrorWrapper(correlationId, RuleIncorrectOrEmptyBodyError.withPaths(Seq("/propertyName", "/countryCode"))))
      }
      ...
      "passed a body with an invalid propertyName" in {
        ...
        result shouldBe Left(ErrorWrapper(correlationId, RuleFormatPropertyNameError))
      }
      ...
      "passed a body with an invalid endDate" in {
        ...
        result shouldBe Left(ErrorWrapper(correlationId, RuleFormatEndDateError))
      }
      ...
      "passed a body with an invalid endReason" in {
        ...
        result shouldBe Left(ErrorWrapper(correlationId, RuleFormatEndReasonError))
      }
    }
    ...
    "return multiple errors" when {
      ...
      "passed a body with an invalidly formatted propertyName and missing end details" in {
        ...
        result shouldBe Left(ErrorWrapper(correlationId, BadRequestError, Some(List(RuleFormatPropertyNameError, RuleMissingEndDetailsError))))
      }
    }
  }
