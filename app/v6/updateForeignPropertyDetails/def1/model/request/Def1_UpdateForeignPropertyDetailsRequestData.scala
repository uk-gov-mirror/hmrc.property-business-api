...
case class Def1_UpdateForeignPropertyDetailsRequestData(nino: Nino,
                                                        propertyId: PropertyId,
                                                        taxYear: TaxYear,
                                                        body: Def1_UpdateForeignPropertyDetailsRequestBody)
    extends UpdateForeignPropertyDetailsRequestData {
  val schema: UpdateForeignPropertyDetailsSchema = UpdateForeignPropertyDetailsSchema.Def1
}
