...
import v6.updateForeignPropertyDetails.UpdateForeignPropertyDetailsSchema.Def1
...
class UpdateForeignPropertyDetailsValidatorFactory {
  ...
  def validator(nino: String, propertyId: String, taxYear: String, body: JsValue): Validator[UpdateForeignPropertyDetailsRequestData] = {
    ...
    schema match {
      case Valid(Def1) => new Def1_UpdateForeignPropertyDetailsValidator(nino, propertyId, taxYear, body)
